...
public class ServerMain {
	...
	public static void main(String[] args) throws Exception {
		JSONObject haha = SideBySideThreeWayDiff.diff("one.txt", "two.txt", "three.txt");
	    System.out.println("count: " + SideBySideThreeWayDiff.countConflicts("one.txt", "two.txt", "three.txt"));
