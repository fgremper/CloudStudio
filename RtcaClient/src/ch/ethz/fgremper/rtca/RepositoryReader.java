	...
	public RepositoryReader(String localPath) throws Exception {
        ...
        for (Ref ref : refs) {
        	...
        	if (ref.getName().startsWith("refs/heads/")) {
	            ...
	            if (isActiveBranch) {	            
	            	// Store active branch
		            activeBranch.put("branch", branchName);
		            activeBranch.put("commit", commitId);
		            // TODO: find out time of last update or something?
