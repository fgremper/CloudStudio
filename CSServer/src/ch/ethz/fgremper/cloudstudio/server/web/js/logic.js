    ...
    if (selection.showConflicts) {
        sendApiRequest({
            ...
            success: function(data) {
                ...
                renderContentViewDiff3({ content: data.content, filename: filename, repositoryAlias: repositoryAlias, branch: branch, theirUsername: theirUsername, viewAsOrigin: selection.viewAsOrigin });
            },
            error: function (data) {
        ...
        sendApiRequest({
            ...
            success: function(data) {
                console.log("Get content awareness. Success: " + JSON.stringify(data));
                renderContentViewDiff({ content: data.content, filename: filename, repositoryAlias: repositoryAlias, branch: branch, theirUsername: theirUsername, viewAsOrigin: selection.viewAsOrigin });
            },
            error: function (data) {
                displayErrorFromApiFail('Content Level Awareness', data);
            }
